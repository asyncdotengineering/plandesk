...
import type { PutCanvasInput, SerializedEdge, SerializedTask, TaskStatus } from '../../lib/api.js';
...
export function canvasToFlowNodes(tasks: SerializedTask[]): Node<TaskNodeData>[] {
