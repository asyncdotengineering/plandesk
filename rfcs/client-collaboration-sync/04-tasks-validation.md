...
| C21 | `plandesk deploy` agent-assisted self-deploy                         | `packages/plandesk-cli/src/deploy.ts`                    | REQ-12                              | detects `wrangler`/`flyctl`/`docker`, provisions, prints publish command |
